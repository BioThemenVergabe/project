...
//alle Funktionen, die wirklich erst nach dem vollständigen laden der Seite geladen werden dürfen (onclick etc) folgen hier
$(document).ready(function() {
    ...
    //Wenn der download Button trotz disabled geklicked wird, soll eine Meldung erscheinen
    $('#Ergebnisse_download_disabled').click(function(e){
        $('#dashboard_alert2').show();
    });

    //onclick um die Zuweisung/Algorithmus zu starten
    ...
    //Alerts sollen wieder geschlossen werden können
    ...
    //AG_alerts sollen geschlossen werden können
