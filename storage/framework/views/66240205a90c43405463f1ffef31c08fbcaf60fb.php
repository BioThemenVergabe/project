            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <form>
                        ...
                        <label for="passwort1" class="control-label"> <?php echo app('translator')->get('content.modal_endel5'); ?>: <input
                    ...
                    <p class="top-buffer">
                        <?php echo app('translator')->get('content.modal_endel7'); ?>
                    </p>
                    <form id="del_Ratings" action="admin_delete_ratings" method="post">
                        <?php echo e(csrf_field()); ?>

                        <label for="passwort2" class="control-label"> <?php echo app('translator')->get('content.modal_endel5'); ?>: <input
                                    id="passwort2" type="password" required></label>
                        <button type="submit" class="btn btn-danger"><?php echo app('translator')->get('content.modal_endel8'); ?></button>
                    </form>
                </div>
            </div>
